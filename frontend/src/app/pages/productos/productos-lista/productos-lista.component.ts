...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, TableModule, ButtonModule, InputTextModule, DialogModule, MonedaPipe, ProductoFormComponent],
  ...
  styles: [`
    ...
    .text-primary { color: #7B1F3A !important; }
    ...
    :host ::ng-deep .premium-dialog .p-dialog-header .p-dialog-title {
      color: #fff;
      font-weight: 700;
    }

    :host ::ng-deep .premium-dialog .p-dialog-header .p-dialog-header-icon {
      color: rgba(255,255,255,0.8);
    }

    :host ::ng-deep .premium-dialog .p-dialog-header .p-dialog-header-icon:hover {
      color: #fff;
...
export class ProductosListaComponent implements OnInit {
  ...
  cargarProductos() {
    this.loading = true;
    this.productoService.findAll(0, 100).subscribe({
      next: (page) => {
